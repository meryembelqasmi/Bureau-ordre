    ...
    <div class="dashboard">
        <div class="dashboard-nav">
            <header>
                ...
                <a href="{{route('home')}}" class="brand-logo"><i class="fas fa-inbox"></i> <span>Bureau d'ordre</span></a>
            </header>
                ...
                <option value="affaires-presidence">Services des affaires de la présidence et du conseil</option>
                    ...
                    <div class="card">
                        ...
                        <table class="table table-bordered" id="tableau">
                            ...
                            <tbody>
                                @foreach($list as $courrieremploye)
                                    <tr>
                                        <td>{{ $courrieremploye->id}}</td>
                                        <td>{{ $courrieremploye->reference }}</td>
                                        <td>{{ $courrieremploye->daterecu }}</td>
                                        <td>{{ $courrieremploye->analyse }}</td>
                                        <td>{{ $courrieremploye->code }}</td>
                                        <td>{{ $courrieremploye->type_courrier }}</td>
                                        <td>{{ $courrieremploye->id_entrant }}</td>
                                    <form action="{{route('verifier_travail' ,['id'=>$courrieremploye->id])}}" method="POST">
                                        @csrf
