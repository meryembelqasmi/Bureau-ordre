            ...
            <div class="dashboard-content">
                <div class="container">
                    <div class="card">
                        ...
                        <h1>Bienvenue <?php echo e($nom); ?> </h1>
                        </div>
                        <div class="card-body">
                            <p>Le type de ce compte est: employe</p>
                            <p>service :<?php echo e($service); ?></p>
                            <?php if(session()->has('message2')): ?>
                                <p class="alert alert-danger"><?php echo e(session('message2')); ?></p>
                            <?php endif; ?>
                            <?php if(session()->has('message1')): ?>
                            <p class="alert alert-success"><?php echo e(session('message1')); ?></p>
                            <?php endif; ?>
                ...
                <option value="affaires-presidence">Services des affaires de la présidence et du conseil</option>
                    ...
                    <div class="card">
                        ...
                        <table class="table table-bordered" id="tableau">
                            ...
                            <tbody>
                                <?php $__currentLoopData = $list; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $courrieremploye): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <tr>
                                        <td><?php echo e($courrieremploye->id); ?></td>
                                        <td><?php echo e($courrieremploye->reference); ?></td>
                                        <td><?php echo e($courrieremploye->daterecu); ?></td>
                                        <td><?php echo e($courrieremploye->analyse); ?></td>
                                        <td><?php echo e($courrieremploye->code); ?></td>
                                        <td><?php echo e($courrieremploye->type_courrier); ?></td>
                                        <td><?php echo e($courrieremploye->id_entrant); ?></td>
                                    <form action="<?php echo e(route('verifier_travail' ,['id'=>$courrieremploye->id])); ?>" method="POST">
                                        <?php echo csrf_field(); ?>
                                        <td><input type="file" name="realisation"></td>
                                        <td><button class="btn btn-success" type="submit">Envoyer</button></td>
                                    </form>
                                    </tr>
...
</html><?php /**PATH C:\Users\Asus\Music\projetstage\resources\views/employe.blade.php ENDPATH**/ ?>