                ...
                <div class="card">
                    <div class="card-header">
                        <table class="table">
                            ...
                            <tbody>
                                <?php $__currentLoopData = $liste; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $sortant): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <tr>                                  
                                    <td><?php echo e($sortant->reference); ?></td>                                
                                    <td><?php echo e($sortant->daterecu); ?></td>
                                    <td><?php echo e($sortant->code); ?></td>
                                    <td><?php echo e($sortant->service); ?></td>
                                    <td><?php echo e($sortant->type_courrier); ?></td>  
                                </tr>
...
</html><?php /**PATH C:\Users\Asus\Music\projetstage\resources\views/Sortant.blade.php ENDPATH**/ ?>