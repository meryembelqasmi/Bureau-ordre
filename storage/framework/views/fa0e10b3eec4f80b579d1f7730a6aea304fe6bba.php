                ...
                <div class="card">
                    <div class="card-header">
                        <table class="table">
                            ...
                            <tbody>
                                <?php $__currentLoopData = $entrants; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $entrant): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <tr>
                                   
                                    <td><?php echo e($entrant->reference); ?></td>
                                    <td><?php echo e($entrant->nom_entreprise); ?></td>
                                    <td><?php echo e($entrant->date_recu); ?></td>
                                    <td>
                                        <span class="short-content"><?php echo e(Str::limit($entrant->analyse, 30)); ?></span>
                                        <span class="full-content" style="display: none;"><?php echo e($entrant->analyse); ?></span>
                                        <a href="#" class="toggle-content">Voir</a>
                                    </td>
                                    <td><?php echo e($entrant->code); ?></td>
                                    <td><?php echo e($entrant->service_concerne); ?></td>
                                    <td><?php echo e($entrant->type_de_courrier); ?></td>
                                   
                                    <td>
                                        <a href="<?php echo e(route('ajouter_courrier_employe', [
                                    ...
                                    <td>
                                        <a href="<?php echo e(route('supprimer_courrier_entrant',['id'=>$entrant->id])); ?>">
...
<?php /**PATH C:\Users\Asus\Music\projetstage\resources\views/entrant.blade.php ENDPATH**/ ?>